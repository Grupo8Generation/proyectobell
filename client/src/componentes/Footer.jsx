    ...
    return (
            ...
            <div className="container-fluid footerCont">
                <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-lg-2 col-md-12 col-sm-12 bottom-bar-section">
                        {/* Contenido de la quinta sección */}
                        <ul className="list-unstyled mb-0">
                            <li><b>Consultas:</b></li>
                            <li><a href="#" className="bottom-bar-link">bell.tejidosdeamor@gmail.com</a></li>
                            <br />
                            <li><b> Whatsapp <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
